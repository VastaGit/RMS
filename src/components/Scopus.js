    ...
    <div>
      <div className='bg-gray-100 p-4 rounded-lg'>
        ...
        <p className='mb-2'>
          ...
          articles published in journals covered by Scopus.
        </p>
        <p className='mb-2'>
          3. In order to apply for the Publication Award, the publication in
        ...
        <p className='mb-2'>
          ...
          publication should be published and should appear in Scopus database
          with Article document type. It is not enough to submit a letter of
          acceptance stating that the publication is going to be published.
        </p>
        <p className='mb-2'>
